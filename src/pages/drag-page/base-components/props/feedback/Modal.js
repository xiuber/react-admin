export default {
    fields: [
        {label: '对话框是否可见', field: 'visible', type: 'boolean', version: '', desc: '对话框是否可见'},
        ...
        {label: '取消按钮文字', field: 'cancelText', type: 'ReactNode', defaultValue: '取消', version: '', desc: '取消按钮文字'},
        {label: '垂直居中展示 Modal', field: 'centered', type: 'boolean', defaultValue: false, version: '', desc: '垂直居中展示 Modal'},
        ...
        {label: '确定按钮 loading', field: 'confirmLoading', type: 'boolean', defaultValue: false, version: '', desc: '确定按钮 loading'},
        ...
        {label: '底部内容', field: 'footer', type: 'boolean', defaultValue: true, version: '', desc: '底部内容，当不需要默认底部按钮时，可以设为 footer={null}'},
        ...
        {label: '确认按钮文字', field: 'okText', type: 'ReactNode', defaultValue: '确定', version: '', desc: '确认按钮文字'},
        {label: '确认按钮类型', field: 'okType', type: 'string', defaultValue: 'primary', version: '', desc: '确认按钮类型'},
        ...
        {label: '宽度', field: 'width', type: 'enum', defaultValue: '520', version: '', options: [{value: 'string', label: 'string'}, {value: 'number', label: 'number'}], desc: '宽度'},
        {label: '对话框外层容器的类名', field: 'wrapClassName', type: 'string', version: '', desc: '对话框外层容器的类名'},
        {label: '设置 Modal 的 z-index', field: 'zIndex', type: 'number', defaultValue: '1000', version: '', desc: '设置 Modal 的 z-index'},
