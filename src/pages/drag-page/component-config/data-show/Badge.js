export default {
    ...
    fields: [
        ...
        {label: '展示的数字', field: 'count', type: 'number', version: '', desc: '展示的数字，大于 overflowCount 时显示为 ${overflowCount}+，为 0 时隐藏'},
        {label: '封顶数值', field: 'overflowCount', type: 'number', defaultValue: 99, version: '', desc: '展示封顶的数字值'},
        {
            label: '圆点的大小', appendField: 'count', field: 'size', type: 'radio-group', version: '4.6.0',
            options: [
        ...
        {label: '圆点颜色', appendField: 'dot', field: 'color', type: 'color', version: '', desc: '自定义小圆点的颜色'},
