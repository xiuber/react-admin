...
export const colFields = [
    {label: '弹性比例', field: 'flex', type: 'unit', version: '', desc: 'flex 布局属性'},
...
export default {
    ...
    fields: [
        ...
        {label: '屏幕 < 576px', field: 'xs', type: screenType, version: '', desc: '屏幕 < 576px 响应式栅格，可为栅格数或一个包含其他属性的对象'},
        {label: '屏幕 ≥ 576px', field: 'sm', type: screenType, version: '', desc: '屏幕 ≥ 576px 响应式栅格，可为栅格数或一个包含其他属性的对象'},
        {label: '屏幕 ≥ 768px', field: 'md', type: screenType, version: '', desc: '屏幕 ≥ 768px 响应式栅格，可为栅格数或一个包含其他属性的对象'},
        {label: '屏幕 ≥ 992px', field: 'lg', type: screenType, version: '', desc: '屏幕 ≥ 992px 响应式栅格，可为栅格数或一个包含其他属性的对象'},
        {label: '屏幕 ≥ 1200px', field: 'xl', type: screenType, version: '', desc: '屏幕 ≥ 1200px 响应式栅格，可为栅格数或一个包含其他属性的对象'},
        {label: '屏幕 ≥ 1600px', field: 'xxl', type: screenType, version: '', desc: '屏幕 ≥ 1600px 响应式栅格，可为栅格数或一个包含其他属性的对象'},
    ],
};
